...
label act1:
    ...
    "Я уснул глубоким как никогда сном."
    "Мне показалось, или я там видел кого-то, кого никогда не встречал."
    "Неужели это была {w} Мелисса?"
    ...
    "Вот и она. {w} Моя школа."
    "Я был очень рад когда перевёлся в её, она отличается от моей прошлой школы своей красочностью и живостью."
    "Огромное красивое дерево сакуры цветущее перед школой каждый год является местом сбора всех старшеклассников после уроков."
    "Я по сей день удивляюсь, почему все ученики такие открытые и наровят работать друг с другом в команде, и всё время ищут новые знакомства."
    "С недавних пор в моей жизни появился наглядный пример этого феномена."
    melissa "Хеей!"
    show melissa with dissolve
    melissa "Доброе утро, [username]!"

    if (RespondMessage):
        melissa "Я хотела извиниться за то что так поздно написала."
        ...
        melissa "Слушай...{w} А ты случайно не слышал уведомления вчера вечером?"

        hide melissa
        show melissa_shy

        melissa "Тоесть...{w} Кхм...{w} Я просто хотела сказать, что это я тебе писала."
        melissa "И...{w} Извини если мешала тебе засыпать."
        user "Та ничего."
        user "Погоди.{w} А откуда ты мой номер узнала?"
