...
label start:
    ...
    melissa "Знаешь, говорят что тихие люди очень глубокие и интересные в общении. {w} А ещё у них есть много секретов))"
    ...
    "Чёрт! {w} Она совсем не такая как я. И даже так, мне тяжело признавать это, но... {w} Она такая милая..."
    #hide melissa_shy
    show melissa_r
    user "Нелегко наверное тебе. Нужно уделять время всем друзьям, помнить даты их рождения, помнить кому что нравится, а что нет..."
    melissa "А... {w} На счёт этого... {w} Хоть я и общительная, но друзей у меня немного."
    ...
    hide melissa_surp
    show melissa
    melissa "Смотри! Мне кажется мы пришли, это твой дом!"
    hide melissa
    #show melissa_shy
    ...
    user "Тогда я пойду наверное... {w} Уже темнеет, так что скорее беги домой."
    #hide melissa_shy
    show melissa_r
    melissa "Да, ты прав! {w} Тогда я побежала!"
